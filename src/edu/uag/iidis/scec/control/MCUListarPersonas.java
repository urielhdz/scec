...
public final class MCUListarPersonas
    ...
    public ActionForward solicitarListarAlgunasPersonas(
                ActionMapping mapping,
                ActionForm form,
                HttpServletRequest request,
                HttpServletResponse response)
        ...
        FormaListadoPersonasAJAX forma = (FormaListadoPersonasAJAX)form;

        ManejadorPersonas mr = new ManejadorPersonas();
        Collection resultado = mr.listarAlgunasPersonas(request.getParameter("cadena"),request.getParameter("order"));
